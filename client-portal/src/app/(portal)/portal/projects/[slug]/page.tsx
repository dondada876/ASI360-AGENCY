...
export default async function ProjectDetailPage({
  ...
  const { data: project } = await supabase
    ...
    .select(
      "id, project_no, project_name, slug, client_name, project_status, current_phase, start_date, target_close_date, business_type, health_score, description, scope_description, site_address, contact_name, contact_email, contact_phone"
    )
